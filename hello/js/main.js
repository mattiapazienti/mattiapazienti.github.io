...
;(function(window) {
	...
	var support = {transitions : Modernizr.csstransitions},
		...
		// the mall element
		mall = document.querySelector('.hello'),
		...
		mallNav = document.querySelector('.hellonav'),
		// show all mall´s levels ctrl
		allLevelsCtrl = mallNav.querySelector('.hellonav__button--all-levels'),
		// levels navigation up/down ctrls
		levelUpCtrl = mallNav.querySelector('.hellonav__button--up'),
		levelDownCtrl = mallNav.querySelector('.hellonav__button--down'),
		// pins
